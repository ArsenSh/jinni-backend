    ...
    return [
        {
            ...
            content:
              ...
              + (canQuoteFares
                  ...
                  + 'Given a LENGTH of stay instead of a date ("4 days"), price the return leg as a one-way window from '
                  + 'the earliest outbound plus the stay to the latest outbound plus the stay, and say which outbound each '
                  + 'return pairs with; never ask again for a date they said they have not chosen. '
