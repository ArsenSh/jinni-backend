...
router.get('/', authenticateToken, async (req, res) => {
    try {
        ...
        const settings = {
            ...
            fontStyle: user.settings?.fontStyle || 'elegant',
...
router.patch('/', authenticateToken, async (req, res) => {
    try {
        ...
        if (fontStyle && ['standard', 'classic', 'elegant', 'modern', 'rounded', 'journal'].includes(fontStyle)) { updateData['settings.fontStyle'] = fontStyle }
